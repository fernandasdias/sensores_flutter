  ...
  void initState() {
    ...
    motionSensors.magnetometer.listen((MagnetometerEvent event) {
      setState(() {
        ...
        var azimuth = _absoluteOrientation2[0] * 57.2957795;
        var pitch = _absoluteOrientation2[1] * 57.2957795;
        var roll = _absoluteOrientation2[2] * 57.2957795;
        print('\nazimuth ' +
            azimuth.toStringAsFixed(4) +
            'pitch  ' +
